    ...
    <div>
        <div className="container pt-16 pb-16 grid-cols-2 ">
            ...
            <div className="grid lg:grid-cols-[300px, 1fr] gap-4">
                ...
                p-6 lg:pg-0">
                    <div className="text-color flex flex-col items-center gap-1">
                        <Image 
                        ...
                        <p className="max-w-[200px] text-gray-500">
                            ...
                            Voluptate, saepe tempore! Ab vel dolorum aliquam tempora 
                            accusantium necessitatibus quas dicta, cumque pariatur animi a
                            spernatur minima enim numquam a eveniet fugiat.
                        </p>
                    </div>
                </div>
